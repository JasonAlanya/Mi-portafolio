  ...
  return (
    <div id="Contact">
      ...
      <div className='Footer'>
        <img src={logo} alt="" />
        <p>The moment you are afraid to jump is the best moment to act.</p>
        <div className="home_social">
          <a target="__blank" aria-label="github" title="github" href="https://github.com/JasonAlanya">
          ...
          <a target="__blank" aria-label="twitter" title="twitter" href="https://twitter.com/alanya_jason">
        ...
        <h2>Designed & built by <a href='https://github.com/JasonAlanya'>Jason Alanya</a> ©</h2>
      </div>
    </div>
  )
}
