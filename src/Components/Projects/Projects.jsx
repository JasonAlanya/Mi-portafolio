...
const Projects = () => {
  ...
  useEffect(()=>{
    const elemento1=document.getElementById("project1");
    const elemento2=document.getElementById("project2");
    const elemento3=document.getElementById("project3");
    const elemento4=document.getElementById("project4");
    const elemento5=document.getElementById("project5");
    const elemento6=document.getElementById("project6");
    ...
    <div id="Projects">
      ...
      <div className='timeline'>
        <ul>
          ...
          <li id='project6'>
            <div className='content'>
              <h3>Development of an IoT system using ESP8266 for the detection of asthma triggering allergens in children</h3>
